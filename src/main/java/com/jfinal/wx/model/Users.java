...
public class Users extends Model<Users> {
	...
	public List<Users> getAll(){
		return me.find("select * from wx_users");
	}
	...
	public Page<Users> paginate(int pageNumber, int pageSize) {
		return paginate(pageNumber, pageSize, "select *", "from wx_users order by id asc");
	}
	
	public Users findByOpenId(String openId){
		return this.findFirst("select * from wx_users where openId=?", openId);
	}
	...
	public List<Users> findByMap(Map<String, Object> paras) {
		StringBuilder sql = new StringBuilder("select * from wx_users ");
